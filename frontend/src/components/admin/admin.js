...
import Selector from "./UserPanel/Appoitment/Selector";
import MyBookings from "./UserPanel/Appoitment/MyBookings";
    ...
    return (
      <React.Fragment>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/app/bookappointment/:doctor_id/"
            component={BookAppoinment}
          />

          <Route exact path="/app/mybookings/" component={MyBookings} />
        </Switch>
      </React.Fragment>
    );
  }

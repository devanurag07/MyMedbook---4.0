...
from users.models import AccessRequest, DateTimeSlot, TimeSlot
...
class UsersSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def get_tags(self, instance):
        if(instance.profile.tags):
            tags = instance.profile.tags.all().values_list("tag")
            return list(tags)
        return []
...
class UserSerializerReadOnly(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'clinic_name',
            'state', 'country', 'pin_code', 'your_sign', 'tags', 'address_line2', 'address_line1', 'city'
        )
...
class BillingInvoiceSerializer(serializers.ModelSerializer):
    ...
    def get_doctor_data(self, instance):
        request = self.context["request"]
        data = UserSerializerReadOnly(instance.created_by, many=False, context={

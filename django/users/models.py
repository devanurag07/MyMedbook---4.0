...
class UserProfile(models.Model):
    ...
    # Appointment Price
    consultation_charges = models.IntegerField(default=500)
...
class AppointmentModel(models.Model):
    ...
    consultation_charges = models.PositiveIntegerField()
    ...
    order_id = models.CharField(null=False, max_length=255)
